...
@NamedQueries({
    ...
    , @NamedQuery(name = "Events.findVersionsByAnalysisUuid", query = "SELECT e FROM Events e WHERE e.category = 'Version' AND e.analysisUuid IN :analysisUuids")})
public class Events implements Serializable {
    ...
    public String toString() {
        return "nl.digkas.sonarqube.domain.Events[ id=" + id + " ]";
    }
