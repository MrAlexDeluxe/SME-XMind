...
@NamedQueries({
    ...
    , @NamedQuery(name = "Issues.findByComponentUuids", query = "SELECT i FROM Issues i WHERE i.componentUuid IN :componentUuids")})
public class Issues implements Serializable {
    ...
    public String toString() {
        return "nl.digkas.sonarqube.domain.Issues[ id=" + id + " ]";
    }
